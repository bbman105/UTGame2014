...
public partial class LoadingScene : MonoBehaviour
{
    ...
    {
        get { return LoadingScene.eventNum; }
        set { LoadingScene.eventNum = value; }
    }
    //事件觸碰事件回饋字典
    ...
    {
        get { return LoadingScene.touchFeedBackNum; }
        set { LoadingScene.touchFeedBackNum = value; }
    }
    private static int personalityNum;
    public static int PersonalityNum
    {
        get { return LoadingScene.personalityNum; }
        set { LoadingScene.personalityNum = value; }
    }
    //事件回答類型字典
    ...
    {
        get { return LoadingScene.eventFeedBackNum; }
        set { LoadingScene.eventFeedBackNum = value; }
    }

    private static int curEventID;
    public static int CurEventID
    {
        get { return LoadingScene.curEventID; }
        set { LoadingScene.curEventID = value; }
    }

    static GameObject RoomResourceSpawnerObj { get; set; }//房間物件產生器
    static GameObject RoomResourceSpawnerResourceObj { get; set; }//房間物件產生器的位置物件

    public static void LoadEventFeedBack()
    {
    ...
    public static void LoadTouchFeedBackXml()
    {
        try
        {
    ...
    public static void LoadDialogueXml()
    {
    ...
    public static void SpawnRoomResourceObjList()//建立資源清單物件
    {
        ///////////////////////////////////////////////LoadEventUI////////////////////////////////////////
    ...
    {
        myGameObject.AddComponent<ResourceUI>();
        myGameObject.AddComponent<TrainSceneInterfaceUI>();
        myGameObject.AddComponent<TrainSceneUICtrl>();
    }
    ...
    void Start()
    {
        ...
        ArcaletSetter.StartSetArcaletSetter();
    }
}
